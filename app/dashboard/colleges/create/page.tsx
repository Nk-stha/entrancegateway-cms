...
import type { CollegeType, CollegeAffiliation, CollegePriority } from '@/types/college.types';
            ...
            <div className="lg:col-span-1 space-y-8">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex items-center justify-between py-3 border-t border-gray-100">
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-gray-900">Visibility Status</span>
                      <span className="text-xs text-gray-500">Show on public site</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => setIsVisible(!isVisible)}
                      className={`${
                        isVisible ? 'bg-brand-blue' : 'bg-gray-200'
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      College Logo <span className="text-red-600">*</span>
                    </label>
                    {logoPreview ? (
                      <div className="relative">
                        <img
                  ...
                  <div className="border-t border-gray-100 pt-6">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Image Gallery <span className="text-red-600">*</span>
                    </label>
                    ...
                    <div className="mt-1 flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-6 pt-5 pb-6 hover:border-brand-blue hover:bg-blue-50/30 transition-colors bg-gray-50 cursor-pointer">
                      <div className="space-y-1 text-center">
                        ...
                        <p className="text-xs text-gray-500">
                          {imagePreviews.length > 0 
                            ? `${imagePreviews.length} image${imagePreviews.length > 1 ? 's' : ''} selected. Add more...`
